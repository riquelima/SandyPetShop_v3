...
async def run_test():
    ...
    try:
        ...
        # -> Fill in pet and owner details and click 'Próximo →' to proceed to service selection.
        ...
        # -> Select 'Banho & Tosa' as the regular service type and click 'Próximo →' to proceed to the time selection.
        frame = context.pages[-1]
        ...
        frame = context.pages[-1]
        # Click 'Próximo →' to proceed to time selection
        ...
        try:
            ...
            raise AssertionError("Test case failed: The appointment scheduling process did not complete successfully as expected between 9:00 and 17:00 excluding lunch break 12:00-13:00.")
