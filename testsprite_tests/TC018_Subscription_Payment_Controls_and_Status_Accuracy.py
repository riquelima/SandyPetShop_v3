...
async def run_test():
    ...
    try:
        ...
        # -> Fill in pet and owner information and proceed to the next step.
        ...
        frame = context.pages[-1]
        # Click Próximo to go to the next step
        elem = frame.locator('xpath=html/body/div/div/main/form/div[2]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Select a service category and proceed to the next step.
        frame = context.pages[-1]
        ...
        # -> Click 'Próximo →' to proceed to the next step for scheduling.
        frame = context.pages[-1]
        ...
        # -> Select a service option to enable the 'Próximo →' button and proceed to the next step.
        frame = context.pages[-1]
        ...
        # -> Select pet weight from dropdown and then click 'Próximo →' to proceed to the next step.
        frame = context.pages[-1]
        ...
        # -> Click 'Próximo →' button to proceed to the scheduling step.
        frame = context.pages[-1]
        # Click 'Próximo →' button to proceed to scheduling step
        elem = frame.locator('xpath=html/body/div/div/main/form/div[2]/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Select a date and time slot to enable the 'Próximo →' button and proceed to the next step.
        frame = context.pages[-1]
        # Select date 10 (October 10, 2025)
        elem = frame.locator('xpath=html/body/div/div/main/form/div/div/div/div[3]/button[11]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        frame = context.pages[-1]
        # Click 'Próximo →' button to proceed to the next step
        elem = frame.locator('xpath=html/body/div/div/main/form/div[2]/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Click the 'Confirmar Agendamento' button to finalize the appointment and trigger payment processing.
        frame = context.pages[-1]
        # Click 'Confirmar Agendamento' button to finalize the appointment and trigger payment processing
        elem = frame.locator('xpath=html/body/div/div/main/form/div[2]/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Subscription Payment Confirmed').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test failed: Payment for subscription client did not update client status to active or appointments did not reflect payment state as expected.")
